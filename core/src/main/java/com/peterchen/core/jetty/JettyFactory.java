 ...
 */
package com.peterchen.core.jetty;
...
public class JettyFactory {
    ...
    public static final String ROOT_PROJECT = "wolflowhereu";
    ...
    public static Server createServerInSource(int port, String contextPath) {
        ...
        String webAppPath = DEFAULT_WEBAPP_PATH;
        if (System.getProperty("user.dir").endsWith(File.separator + ROOT_PROJECT)) {
            webAppPath = contextPath + "/" + webAppPath;
        }
